...
# from src.model import PatchTST             <-- Comment this out
from baselines import DLinear          # <-- Uncomment/Add this
class EarlyStopping:
    """
...
def train():
    ...
    early_stopping = EarlyStopping(patience=patience, verbose=True, path='best_model_baseline.pth')
    ...
    # --- Final Test ---
    print("\n--- Testing Best Model ---")
    model.load_state_dict(torch.load('best_model_basleline.pth'))
    model.eval()
